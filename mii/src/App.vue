        ...
        <b-collapse id="nav-collapse" is-nav>
          ...
          <b-navbar-nav class="ml-auto">
            ...
            <b-nav-item-dropdown right>
              ...
              <b-dropdown-item v-if="isLoggedIn == false" href="#" @click="isLoggedIn = true">Log In</b-dropdown-item>
              <b-dropdown-item v-else href="#" @click="isLoggedIn = false">Log Out</b-dropdown-item>
            </b-nav-item-dropdown>
          </b-navbar-nav>
        </b-collapse>
      </b-navbar>
